...
import "./components/_detect-adblock.js"; // Обнаружение адблок

// import "./components/_detect-platform.js";
// import "./components/_theme-toggle-btn.js";

// ----------------------------------------------------------------------
// * обновить работу галп сборки
// * проверить тормоза
// * проверить работу галп, и др. раннеров во всех проектах
// * проверить дубликат стилей css в консоле браузера
// * при открытии/закрытии консоли неправильно пересчитывается позиция скролла
// * проверить/поправить бэм, верстка и стили
// * scroll-hidden - дергается сайт(пофиксить)
// * removeEventListener там где возможно
// * рендер красного текста
// * проверить баги noscript
// * переделать название атрибута тултипа
// * проверить работу в IE
// * проверить работу access()
// * зависает таймер на неактивной вкладке (gulp)
// * webp
// * обернуть все в трайкатчь
// * в ie поправить бургер
